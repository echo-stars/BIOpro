...
y_train = np.array(y_train,dtype='float16') # transformed as np.array for CNN model
...
y_test = np.array(y_test,dtype='float16') # transformed as np.array for CNN model
...
# training dataset loading
dataset = pd.read_excel('../data/orginal/all_train.xlsx',na_filter = False)
sequence_list = dataset['SequenceID']
...
dataset = pd.read_excel('../data/orginal/all_test.xlsx',na_filter = False)
sequence_list = dataset['SequenceID']
